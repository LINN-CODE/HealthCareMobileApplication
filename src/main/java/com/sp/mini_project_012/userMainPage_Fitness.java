...
public class userMainPage_Fitness extends AppCompatActivity {
    private String userId;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_user_main_page_fitness);
        ...
        bottomNavigationView.setSelectedItemId(R.id.bottom_fitness_user);
